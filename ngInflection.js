angular.module('ngInflection', [])
	.filter('indexOf', function () { return function(arr, item) { if (arr && item) return inflection.indexOf.apply(this, arguments); } })
	...
	.filter('inflect', function () { return function(string, number) { if (string && number) return inflection.inflect.apply(this, arguments); } })
